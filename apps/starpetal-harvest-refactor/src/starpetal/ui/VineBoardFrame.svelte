<script lang="ts">
	...
	import { BOARD_FRAME_INSET, BOARD_FRAME_WIDTH_SCALE } from './draw/boardInnerFrame';
	import { drawVineReelFrameBorder } from './draw/drawVineReelFrame';
	import { THEME } from '../config/theme';

	// Vine reel frame — procedural Graphics, replaces the engine's sprite BoardFrame.
