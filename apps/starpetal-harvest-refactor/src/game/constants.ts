...
// Seam: symbol map comes from the starpetal layer (sprite art). The cluster
// definition below is kept (unexported) for reference only.
export { symbolMap as SYMBOL_INFO_MAP } from '$starpetal/bridge';

const _CLUSTER_SYMBOL_INFO_MAP = {
	H1: {
		explosion,
		win: {
			type: 'spine',
