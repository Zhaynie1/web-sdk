...
const baseAssets = {
	...
	foregroundAnimation: {
		...
		// not preloaded — the MM Background.svelte is no longer rendered; the grove
		// video (StarpetalBackground) is the background.
	},
...
// Seam: merge starpetal art overrides over the engine's base manifest.
export default { ...baseAssets, ...starpetal.assets };
